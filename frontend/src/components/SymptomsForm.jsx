...
const SymptomsForm =({ onsubmit }) => {
  ...
  return (
    <div className='max-w-2xl mx-auto mt-10 p-6 md:p-10 bg-black text-white rounded-2xl shadow-2xl'>
      <h2 className='text-3xl font-extrabold text-orange-500 mb-6 text-center'>🩺 Disease Analyzer from Symptoms</h2>

      <form onSubmit={handleSubmit} className='space-y-6'>

        {/* Name */}
        <div>
          <label className='block mb-1 font-semibold text-orange-400'>Name:</label>
          <input
            type="text"
            value={name}
        ...
        {/* Age */}
        <div>
          <label className='block mb-1 font-semibold text-orange-400'>Age:</label>
          <input
            type="number"
            value={age}
        ...
        {/* Gender */}
        <div>
          <label className='block mb-1 font-semibold text-orange-400'>Gender:</label>
        ...
        {/* Symptom Search */}
        <div>
          <label className='block mb-1 font-semibold text-orange-400'>Search Symptoms:</label>
          <input
            type="text"
            value={query}
          ...
          {selectedSymptoms.length > 0 && (
            <div className="mt-4">
              <p className='font-semibold mb-2 text-orange-400'>Selected Symptoms:</p>
